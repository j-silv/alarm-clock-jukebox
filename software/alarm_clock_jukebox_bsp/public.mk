...
# setting SOPC_SYSID_BASE_ADDRESS is 0x210c0
SOPC_SYSID_FLAG += --sidp=0x210c0
ELF_PATCH_FLAG  += --sidp 0x210c0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1612774744
SOPC_SYSID_FLAG += --timestamp=1612774744
ELF_PATCH_FLAG  += --timestamp 1612774744
